...
/**
 * Pretty printer for Jackson with less unorthodox default.
 */
public final class JsonPrettyPrinter extends DefaultPrettyPrinter {
    /**
     * Creates a pretty printer with the default separators.
     */
    public JsonPrettyPrinter() {
        super(new Separators(
                Separators.DEFAULT_ROOT_VALUE_SEPARATOR,
                ':', Spacing.AFTER, ',', Spacing.NONE, "",
                ',', Spacing.NONE, ""
        ));
     ...
     * Copy constructor.
     *
     * @param base Pretty printer to copy from.
     */
