...
import com.itextpdf.rups.view.itext.treenodes.asn1.correctors.x509.TimeCorrector;

import org.bouncycastle.asn1.ASN1Primitive;

/**
 * Corrector for the signingTime attribute, as it is defined in RFC 2985.
 *
 * <pre>
 ...
 * </pre>
 */
public final class SigningTimeCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final SigningTimeCorrector INSTANCE = new SigningTimeCorrector();

    private SigningTimeCorrector() {
        // singleton class
    }
    ...
    public void correct(AbstractAsn1TreeNode node, ASN1Primitive obj, String variableName) {
        TimeCorrector.INSTANCE.correct(node, obj, variableName);
    }
}
