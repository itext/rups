...
/**
 * Corrector for the ocspServiceLocator attribute, as it is defined in RFC 6960.
 *
 * <pre>
 ...
 * </pre>
 */
public final class OcspServiceLocatorCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final OcspServiceLocatorCorrector INSTANCE = new OcspServiceLocatorCorrector();

    private OcspServiceLocatorCorrector() {
        // singleton class
    }
    ...
    public void correct(AbstractAsn1TreeNode node, ASN1Primitive obj, String variableName) {
        ...
        if (node.getChildCount() > 1) {
            AuthorityInfoAccessCorrector.INSTANCE.correct(node.getChildAt(1), "locator");
        }
    }
}
