...
/**
 * Corrector for the ocspNocheck attribute, as it is defined in RFC 6960.
 *
 * <pre>
 * Nocheck ::= NULL
 * </pre>
 */
public final class OcspNocheckCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final OcspNocheckCorrector INSTANCE = new OcspNocheckCorrector();

    private OcspNocheckCorrector() {
        // singleton class
    }
