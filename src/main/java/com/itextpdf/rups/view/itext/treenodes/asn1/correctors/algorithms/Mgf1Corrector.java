...
/**
 * Corrector for the MGF1 parameters, as they are defined in RFC 8017.
 *
 * <pre>
 * mgf1-params ::= HashAlgorithm
 * </pre>
 */
public final class Mgf1Corrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final Mgf1Corrector INSTANCE = new Mgf1Corrector();

    private Mgf1Corrector() {
        // singleton class
    }
     ...
     */
    public static final String OID = "1.2.840.113549.1.1.8";
    ...
    public void correct(AbstractAsn1TreeNode node, ASN1Primitive obj, String variableName) {
        AlgorithmIdentifierCorrector.INSTANCE.correct(node, obj, variableName);
    }
}
