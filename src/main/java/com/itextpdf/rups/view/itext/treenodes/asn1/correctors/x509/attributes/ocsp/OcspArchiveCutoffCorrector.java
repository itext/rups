...
/**
 * Corrector for the ocspArchiveCutoff attribute, as it is defined in RFC 6960.
 *
 * <pre>
 * ArchiveCutoff ::= GeneralizedTime
 * </pre>
 */
public final class OcspArchiveCutoffCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final OcspArchiveCutoffCorrector INSTANCE = new OcspArchiveCutoffCorrector();

    private OcspArchiveCutoffCorrector() {
        // singleton class
    }
    ...
    public void correct(AbstractAsn1TreeNode node, ASN1Primitive obj, String variableName) {
        correctPrimitiveUniversalType(node, obj, ASN1GeneralizedTime.class, variableName);
    }
}
