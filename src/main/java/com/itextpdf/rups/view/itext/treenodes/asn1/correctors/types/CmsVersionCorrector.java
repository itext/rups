...
/**
 * Corrector for the CMSVersion type, as it is defined in RFC 5652.
 *
 * <pre>
 * CMSVersion ::= INTEGER { v0(0), v1(1), v2(2), v3(3), v4(4), v5(5) }
 * </pre>
 */
public final class CmsVersionCorrector extends AbstractCorrector {
    /**
     * Array-based map for mapping integer values to labels.
     */
    private static final String[] VERSION_LABELS = {"v0", "v1", "v2", "v3", "v4", "v5"};

    /**
     * Singleton instance of the corrector.
     */
    public static final CmsVersionCorrector INSTANCE = new CmsVersionCorrector();

    private CmsVersionCorrector() {
        // singleton class
    }
