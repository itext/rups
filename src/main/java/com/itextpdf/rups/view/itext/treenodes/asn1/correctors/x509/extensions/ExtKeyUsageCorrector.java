...
/**
 * Corrector for the extKeyUsage extension attribute, as it is
 * defined in RFC 5280.
 *
 * <pre>
 ...
 * </pre>
 */
public final class ExtKeyUsageCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final ExtKeyUsageCorrector INSTANCE = new ExtKeyUsageCorrector();

    private ExtKeyUsageCorrector() {
        // singleton class
    }
    ...
    public void correct(AbstractAsn1TreeNode node, ASN1Primitive obj, String variableName) {
        ...
        for (final AbstractAsn1TreeNode keyPurposeId : node) {
            correctUniversalObjectIdentifier(keyPurposeId, "keyPurposeId");
        }
    }
}
