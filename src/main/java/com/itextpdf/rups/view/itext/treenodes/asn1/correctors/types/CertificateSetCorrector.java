...
/**
 * Corrector for the CertificateSet type, as it is defined in RFC 5652.
 *
 * <pre>
 ...
 *
 * <p>
 * <tt>ExtendedCertificate</tt>, <tt>AttributeCertificateV1</tt> and
 * <tt>AttributeCertificateV2</tt> correction is not implemented and those
 * subtrees will remain untouched. But the subtree root node name will still
 * be applied.
 */
public final class CertificateSetCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final CertificateSetCorrector INSTANCE = new CertificateSetCorrector();

    private CertificateSetCorrector() {
        // singleton class
    }
