...
/**
 * Corrector for the ocspNonce attribute, as it is defined in RFC 6960.
 *
 * <pre>
 * Nonce ::= OCTET STRING
 * </pre>
 */
public final class OcspNonceCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final OcspNonceCorrector INSTANCE = new OcspNonceCorrector();

    private OcspNonceCorrector() {
        // singleton class
    }
