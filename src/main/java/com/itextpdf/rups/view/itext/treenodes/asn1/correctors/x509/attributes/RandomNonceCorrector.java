...
/**
 * Corrector for the randomNonce attribute, as it is defined in RFC 2985.
 *
 * <pre>
 ...
 * </pre>
 */
public final class RandomNonceCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final RandomNonceCorrector INSTANCE = new RandomNonceCorrector();

    private RandomNonceCorrector() {
        // singleton class
    }
     ...
     */
    public static final String OID = "1.2.840.113549.1.9.25.3";
    ...
    public void correct(AbstractAsn1TreeNode node, ASN1Primitive obj, String variableName) {
        correctPrimitiveUniversalType(node, obj, ASN1OctetString.class, variableName);
    }
}
