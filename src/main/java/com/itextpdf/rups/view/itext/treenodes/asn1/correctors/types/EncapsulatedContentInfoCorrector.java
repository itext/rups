...
import com.itextpdf.rups.view.itext.treenodes.asn1.correctors.DefaultCorrector;
...
/**
 * Corrector for the EncapsulatedContentInfo type, as it is defined in RFC
 * 5652.
 *
 * <pre>
 ...
 * </pre>
 */
public final class EncapsulatedContentInfoCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final EncapsulatedContentInfoCorrector INSTANCE =
            new EncapsulatedContentInfoCorrector();

    private EncapsulatedContentInfoCorrector() {
        // singleton class
    }
