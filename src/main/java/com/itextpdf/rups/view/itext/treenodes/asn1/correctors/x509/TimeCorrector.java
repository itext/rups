...
/**
 * Corrector for the Time type, as it is defined in RFC 5280.
 *
 * <pre>
 * Time ::= CHOICE {
 *   utcTime        UTCTime,
 ...
 * </pre>
 */
public final class TimeCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final TimeCorrector INSTANCE = new TimeCorrector();

    private TimeCorrector() {
        // singleton class
    }
    ...
    public static boolean isRootTypeValid(ASN1Primitive obj) {
        return isUniversalType(obj, ASN1UTCTime.class)
                || isUniversalType(obj, ASN1GeneralizedTime.class);
    }
}
