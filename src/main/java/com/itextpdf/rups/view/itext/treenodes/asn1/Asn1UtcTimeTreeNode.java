...
/**
 * Tree node for showing UTCTime ASN.1 objects.
 */
public final class Asn1UtcTimeTreeNode extends AbstractAsn1TreeNode {
    /**
     * Icon to use for UTCTime ASN.1 objects.
     */
    private static final String ICON = "time.png";

    /**
     * Creates a new tree node for a UTCTime ASN.1 object.
     *
     * @param time UTCTime ASN.1 object.
     */
    public Asn1UtcTimeTreeNode(ASN1UTCTime time) {
        super(ICON, time);
        reload();
    }
     ...
     */
    @Override
    public ASN1UTCTime getAsn1Primitive() {
        return (ASN1UTCTime) super.getAsn1Primitive();
    }
