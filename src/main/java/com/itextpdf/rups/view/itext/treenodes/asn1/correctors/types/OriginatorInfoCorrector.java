...
/**
 * Corrector for the OriginatorInfo type, as it is defined in RFC 5652.
 *
 * <pre>
 ...
 * </pre>
 */
public final class OriginatorInfoCorrector extends AbstractSequenceCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final OriginatorInfoCorrector INSTANCE = new OriginatorInfoCorrector();

    private OriginatorInfoCorrector() {
        // singleton class
    }
    ...
    private static final SequenceFieldCorrector[] FIELD_CORRECTORS = {
            OriginatorInfoCorrector::correctCerts,
            OriginatorInfoCorrector::correctCrls,
    };
    ...
    private static boolean correctCerts(AbstractAsn1TreeNode node) {
        ...
        CertificateSetCorrector.INSTANCE.correct(node, getBaseObject(obj));
        return true;
    }

    private static boolean correctCrls(AbstractAsn1TreeNode node) {
        ...
        RevocationInfoChoicesCorrector.INSTANCE.correct(node, getBaseObject(obj));
        return true;
    }
}
