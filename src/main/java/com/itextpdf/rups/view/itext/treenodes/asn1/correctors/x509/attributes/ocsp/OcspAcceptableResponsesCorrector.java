...
/**
 * Corrector for the ocspResponse attribute, as it is defined in RFC 6960.
 *
 * <pre>
 * AcceptableResponses ::= SEQUENCE OF OBJECT IDENTIFIER
 * </pre>
 */
public final class OcspAcceptableResponsesCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final OcspAcceptableResponsesCorrector INSTANCE = new OcspAcceptableResponsesCorrector();

    private OcspAcceptableResponsesCorrector() {
        // singleton class
    }
    ...
    public void correct(AbstractAsn1TreeNode node, ASN1Primitive obj, String variableName) {
        ...
        for (final AbstractAsn1TreeNode acceptableResponse : node) {
            correctUniversalObjectIdentifier(acceptableResponse, "acceptableResponse");
        }
    }
}
