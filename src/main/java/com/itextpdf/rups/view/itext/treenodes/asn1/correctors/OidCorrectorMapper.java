...
import com.itextpdf.rups.view.itext.treenodes.asn1.correctors.x509.extensions.IssuingDistributionPointCorrector;
...
public final class OidCorrectorMapper {
    ...
    private static final Map<String, AbstractCorrector> CORRECTOR_MAP = Map.ofEntries(
            ...
            Map.entry(
                    IssuingDistributionPointCorrector.OID,
                    IssuingDistributionPointCorrector.INSTANCE
            ),
            Map.entry(
