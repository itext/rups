...
/**
 * Corrector for the freshestCRL extension, as it is defined in RFC 5280.
 *
 * <pre>
 * FreshestCRL ::= CRLDistributionPoints
 * </pre>
 */
public final class FreshestCrlCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final FreshestCrlCorrector INSTANCE = new FreshestCrlCorrector();

    private FreshestCrlCorrector() {
        // singleton class
    }
    ...
    public void correct(AbstractAsn1TreeNode node, ASN1Primitive obj, String variableName) {
        CrlDistributionPointsCorrector.INSTANCE.correct(node, obj, variableName);
    }
}
