...
/**
 * Corrector for the contentType attribute, as it is defined in RFC 2985.
 *
 * <pre>
 ...
 * </pre>
 */
public final class ContentTypeCorrector extends AbstractCorrector {
    /**
     * Singleton instance of the corrector.
     */
    public static final ContentTypeCorrector INSTANCE = new ContentTypeCorrector();

    private ContentTypeCorrector() {
        // singleton class
    }
    ...
    public void correct(AbstractAsn1TreeNode node, ASN1Primitive obj, String variableName) {
        correctPrimitiveUniversalType(node, obj, ASN1ObjectIdentifier.class, variableName);
    }
}
