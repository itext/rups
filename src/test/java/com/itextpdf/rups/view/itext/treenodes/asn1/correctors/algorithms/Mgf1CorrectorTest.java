...
final class Mgf1CorrectorTest {
    ...
    void correct_WithoutDefaultName() {
        final AbstractAsn1TreeNode node = createDefaultNode();
        Mgf1Corrector.INSTANCE.correct(node, "mgf1params");
        validateDefaultNode(node, "mgf1params");
    }
    ...
    @Test
    void correct_MissingAlgorithm() {
        // Only root should get named
        final AbstractAsn1TreeNode node = Asn1TreeNodeFactory.fromPrimitive(
    ...
    @Test
    void correct_MissingParameters() {
