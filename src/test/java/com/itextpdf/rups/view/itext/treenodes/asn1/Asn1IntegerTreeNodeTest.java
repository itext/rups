...
@Tag("UnitTest")
final class Asn1IntegerTreeNodeTest {
    @Test
    void toString_Regular() {
        final ASN1Integer obj = new ASN1Integer(1);
        final Asn1IntegerTreeNode node = new Asn1IntegerTreeNode(obj);
        Asn1TestUtil.assertNodeMatches(0, "INTEGER: 1", node);
    }

    @Test
    void toString_Descriptive() {
        final ASN1Integer obj = new ASN1Integer(2);
        final Asn1IntegerTreeNode node = new Asn1IntegerTreeNode(obj);
        node.setRfcFieldName("version");
        node.setValueExplanation("v2");
        Asn1TestUtil.assertNodeMatches(0, "version: 2 (v2)", node);
    }
}
